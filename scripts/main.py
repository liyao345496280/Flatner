...
def main():
    ...
    for epoch in range(start_epoch, config.epochs+1):
        ...
        #                                                                                                   (valid_estimator_1[3][i] * 100),
        #                                                                                                   (valid_estimator_1[4][i] * 100),
        #                                                                                                   (valid_estimator_1[5][i] * 100),
        #                                                                                                   (valid_estimator_1[6][i] * 100)))
        #     i += 1
        print(" -> tag name :PER,accuracy: {:.4f}%, recall: {:.4f}%, F1: {:.4f}%".format((valid_estimator_1[0][1] * 100),(valid_estimator_1[1][1] * 100),(valid_estimator_1[2][1] * 100)),
              "\n","-> tag name :POF,accuracy: {:.4f}%, recall: {:.4f}%, F1: {:.4f}%".format((valid_estimator_1[0][2] * 100),(valid_estimator_1[1][2] * 100),(valid_estimator_1[2][2] * 100)),
              "\n","-> tag name :REI,accuracy: {:.4f}%, recall: {:.4f}%, F1: {:.4f}%".format((valid_estimator_1[0][3] * 100),(valid_estimator_1[1][3] * 100),(valid_estimator_1[2][3] * 100)),
              "\n","-> tag name :CON,accuracy: {:.4f}%, recall: {:.4f}%, F1: {:.4f}%".format((valid_estimator_1[0][4] * 100),(valid_estimator_1[1][4] * 100),(valid_estimator_1[2][4] * 100)),
              "\n","-> tag name :NOA,accuracy: {:.4f}%, recall: {:.4f}%, F1: {:.4f}%".format((valid_estimator_1[0][5] * 100),(valid_estimator_1[1][5] * 100),(valid_estimator_1[2][5] * 100)),
              "\n","-> tag name :ORN,accuracy: {:.4f}%, recall: {:.4f}%, F1: {:.4f}%".format((valid_estimator_1[0][6] * 100),(valid_estimator_1[1][6] * 100),(valid_estimator_1[2][6] * 100)),
              "\n","-> tag name :TIM,accuracy: {:.4f}%, recall: {:.4f}%, F1: {:.4f}%".format((valid_estimator_1[0][7] * 100),(valid_estimator_1[1][7] * 100),(valid_estimator_1[2][7] * 100)))
        ...
        #                                                                        (valid_estimator_1[3][j] * 100),
        #                                                                        (valid_estimator_1[4][j] * 100),
        #                                                                        (valid_estimator_1[5][j] * 100),
        #                                                                        (valid_estimator_1[6][j] * 100)))
        #     j += 1
        print(" -> tag name :PER,accuracy: {:.4f}%, recall: {:.4f}%, F1: {:.4f}%".format((valid_estimator_1[0][1] * 100),(valid_estimator_1[1][1] * 100),(valid_estimator_1[2][1] * 100)),
              "\n","-> tag name :POF,accuracy: {:.4f}%, recall: {:.4f}%, F1: {:.4f}%".format((valid_estimator_1[0][2] * 100),(valid_estimator_1[1][2] * 100),(valid_estimator_1[2][2] * 100)),
              "\n","-> tag name :REI,accuracy: {:.4f}%, recall: {:.4f}%, F1: {:.4f}%".format((valid_estimator_1[0][3] * 100),(valid_estimator_1[1][3] * 100),(valid_estimator_1[2][3] * 100)),
