...
class Config(object):
    ...
    def __init__(self):
        ...
        #
        # # WENWU
        self.label_file = '../dataset/wenwu/tag.txt'
        self.train_file = '../dataset/wenwu/train_data.txt'
        self.dev_file = '../dataset/wenwu/val_data.txt'
        self.test_file = '../dataset/wenwu/test_Data.txt'

        self.vocab = 'E:\pythonProject\KnowledgeGraph\-BERT-BILSTM-DGCNN-ATTENTION-CRF--main\dataset\LERT\\vocab.txt'
        self.max_length = 128
        self.use_cuda = True
        self.gpu = 0
        self.batch_size = 8
        ...
        self.target_dir = 'E:\pythonProject\KnowledgeGraph\-BERT-BILSTM-DGCNN-ATTENTION-CRF--main\\result\\bert_result'
        self.target_dir_yang = 'E:\pythonProject\KnowledgeGraph\-BERT-BILSTM-DGCNN-ATTENTION-CRF--main\\result\\bert_result'
        self.patience = 5
        # 可以换成RoBERTa的中文预训练模型（哈工大提供）
        self.pretrain_model_name = 'E:\pythonProject\KnowledgeGraph\-BERT-BILSTM-DGCNN-ATTENTION-CRF--main\dataset\LERT'
        # self.pretrain_model = [
